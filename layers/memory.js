/**
 * KURO::MEMORY v2.0
 * Session memory with configurable data directory
 */
var fs = require('fs');
var path = require('path');
var MEMORY_DIR = path.join(process.env.KURO_DATA || '/var/lib/kuro', 'sessions');
...
module.exports = { getSession, addToHistory, getContext, clearSession, saveSession };
